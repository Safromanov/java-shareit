...
ALTER TABLE item_request ADD CONSTRAINT FK_ITEMREQUEST_ON_REQUESTOR FOREIGN KEY (requestor_id) REFERENCES users (user_id);
...
ALTER TABLE booking ADD CONSTRAINT FK_BOOKING_ON_BOOKER FOREIGN KEY (booker_id) REFERENCES users (user_id);

ALTER TABLE booking ADD CONSTRAINT FK_BOOKING_ON_ITEM FOREIGN KEY (item_id) REFERENCES items (item_id);
